...
leadership: a beverage-led path back to profitability, with the analysis, the wine program,
and the staff training designed to execute it.

This repo is the **redacted** version of that work.
...
| File | Contents |
|---|---|
| `CASE-STUDY.md` | The full business case: five financial models (method only) plus the wine-menu design and the server & host training programs built to execute the strategy |
...
per guest, and a beverage share target), corrected the P&L lens (stripping casino comps to
see true cash economics), and then built the operational machinery to make it happen: a
pairing-driven wine menu, a six-segment server certification program with incentives, and
a four-week host training program.

## Contents of the original packet (not included)

Analytical memos on average alcohol profit margin, beverage sales relative to revenue,
average guest spend (two methods), marginal profitability of incremental wine sales, and
comp-adjusted profitability; a wine-menu proposal; a server training certification
program; and a four-week host training program. All written July 2024.
